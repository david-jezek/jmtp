...
//    @SuppressWarnings("unused")
    ...
    native String createObjectWithPropertiesAndData(PortableDeviceValuesImplWin32 values,
            InputStream content, long size) throws COMException;
    native String updateObjectWithPropertiesAndData(String objectID, PortableDeviceValuesImplWin32 values,
            InputStream newContent, long size) throws COMException;
